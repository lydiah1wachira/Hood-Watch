...
SECRET_KEY = 'django-insecure-a#8zcz)3yt7=4vh5ntclx9gu*%oemc@y+ufyt)cc-%^ox@xoku'
...
cloudinary.config( 
  cloud_name = "dzc2fvt9a",  
  api_key = "469381447855196", 
  api_secret = "O65PpSAfpkrux_nRTg6Pqbe-7NA" 
)
